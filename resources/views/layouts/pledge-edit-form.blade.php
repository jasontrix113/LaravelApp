                ...
                <div class="panel panel-default col-sm-8 col-sm-offset-2" id="pledge-form">
                    <div class="col-sm-6">
                        <div class="panel-heading" style="padding: 10px 0; margin-top: 40px;">
                            <legend><span><i class="fa fa-pencil"></i></span> Transaction Details</legend>
                        </div>
                        <div class="panel-body" style="padding: 0;"> 
                            <div class="form-group">
                                <label for="current_gr" class="control-label" id="label-pledge" autocomplete="off">Current Gold Rate*</label>
                                <input type="text" disabled="true" class="form-control" name="current_gr" value="2000" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="textarea" class="form-control"  style="height: 80px;" name="article" autocomplete="off"></textarea> 
                            </div>
                        </div><!-- panel-body -->       
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="panel-heading" style="padding: 10px 0; margin-top: 40px;">
                            <legend><span><i class="fa fa-pencil"></i></span> Personal Details</legend>
                        </div> 
                        <div class="panel-body" style="padding: 0;">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  class="form-control"  name="contactnum" autocomplete="off"> 
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  class="form-control"  name="appraiser" autocomplete="off" value="{{ Auth::user()->name }}"> 
                            </div> 
                            <div class="form-group" id="submit-btn" style="float: right;">
                                <button type="submit" name="btn-save" id="btn-save" class="btn btn-success"><span><i class="fa fa-save"></i></span> Save</button>
                            </div>  
                        </div><!-- panel-body  -->    
                    </div>   
                </div><!--  panel-default --> 
